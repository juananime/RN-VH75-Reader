...
/**
 * Device class，Contains all command operations
 * 
 * @author lgnhm_000
 */
public class VH73Device {
	...
	/**
	 * Parse the result of the record
	 * 
	 * @param data
	...
	/**
	 * Parse the result of the version number
	 * 
	 * @param data
	 * @return
	 */
	...
	/**
	 * Parse the basic parameters of the device
	 * 
	 * @param data
	 * @return
	 */
	...
	/**
	 * Get the data portion of the result
	 * 
	 * @param data
	 * @return
	 */
	 ...
	 */
	private byte[] xgenerateCMD(CommandCode cmd, byte[] param) {
		int len = 1 + 1; // cmd + checksum
		if (param != null) {
			len = len + param.length; // param
		}
